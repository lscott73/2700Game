export  default class CardData {
    constructor(cashCost, leverageCost, cashValue, leverageValue, powerValue, powerPenalty, sprite, state) {
    ...
    this.powerPenalty = powerPenalty; // Cash penalty for ending the turn with this card in the center board
    ...
    setpowerPenalty(powerPenalty) {
        this.powerPenalty = powerPenalty;
    }
